...
View(FAST_Admission)
# ################################################## Question 2 ################################################## #
# Inter-marks based on NTS/NU test offered

offered_admission = tail(FAST_Admission[!is.na(FAST_Admission$X33) | !is.na(FAST_Admission$X35) ,]$X20, -1)
...
boxplot(offered_admission, main = "Box plot of Inter-Marks based on NU/NTS test" , ylab = "Inter-Marks")

# Getting outliers in Inter-Marks offered admission.
...
not_offered_admission = tail( FAST_Admission[(is.na(FAST_Admission$X33) & is.na(FAST_Admission$X35) 
                                              ...
                                              & (is.na(FAST_Admission$X29) | is.na(FAST_Admission$NU.Merit.Marks) | is.na(FAST_Admission$X31)) ) ,]$X20, -1)
# Remove NA values 
...
boxplot(not_offered_admission, main = "Box plot of Inter-Marks of students not offersd based on NU/NTS test" , ylab = "Inter Marks")

# Getting outliers in Inter-Marks not offered admission.
